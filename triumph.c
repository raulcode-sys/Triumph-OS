...
static int b_help(Cmd *c){(void)c;
    ...
    const char *h[][2]={
        ...
        {"clear","clear screen"},{"nano/edit","text editor"},{"snake","snake game"},{"tetris","tetris game"},{"poweroff","power off the machine"},{"fetch","system info panel"},
...
static BE btab[]={
    ...
    {"echo",b_echo},{"edit",b_edit},{"nano",b_edit},{"vi",b_edit},{"snake",b_snake},{"tetris",b_tetris},{"poweroff",b_poweroff},{"shutdown",b_poweroff},{"reboot",b_reboot},
